...
#define ACC_SME_DESC_ERROR (*((volatile unsigned int *)(IO_EXT_BASE + 0x0410)))
#define ACC_SME_DONE_ERROR (*((volatile unsigned int *)(IO_EXT_BASE + 0x0414)))
...
int main(void)
{
  ...
  accel_context[0].sme_accel->state = 0;
