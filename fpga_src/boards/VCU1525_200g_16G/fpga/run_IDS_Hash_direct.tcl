...
create_fileset -quiet IDS_Hash_direct_utils
add_files -fileset IDS_Hash_direct_utils -norecurse ../lib/axis/syn/vivado/sync_reset.tcl
add_files -fileset IDS_Hash_direct_utils -norecurse ../lib/smartFPGA/syn/vivado/simple_sync_sig.tcl
set_property STEPS.OPT_DESIGN.TCL.PRE [ get_files ../lib/axis/syn/vivado/sync_reset.tcl -of [get_fileset IDS_Hash_direct_utils] ] [get_runs impl_IDS_Hash_direct]
set_property STEPS.OPT_DESIGN.TCL.PRE [ get_files ../lib/smartFPGA/syn/vivado/simple_sync_sig.tcl -of [get_fileset IDS_Hash_direct_utils] ] [get_runs impl_IDS_Hash_direct]
set_property STEPS.ROUTE_DESIGN.TCL.PRE [ get_files ../lib/axis/syn/vivado/sync_reset.tcl -of [get_fileset IDS_Hash_direct_utils] ] [get_runs impl_IDS_Hash_direct]
set_property STEPS.ROUTE_DESIGN.TCL.PRE [ get_files ../lib/smartFPGA/syn/vivado/simple_sync_sig.tcl -of [get_fileset IDS_Hash_direct_utils] ] [get_runs impl_IDS_Hash_direct]
