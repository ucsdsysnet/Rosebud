...
# SFP+ Interfaces
set_property -dict {LOC D2  } [get_ports sfp_1_rx_p] ;# MGTHRXN0_227 GTHE3_CHANNEL_X0Y12 / GTHE3_COMMON_X0Y3
...
set_property -dict {LOC C4  } [get_ports sfp_2_rx_p] ;# MGTHRXN1_227 GTHE3_CHANNEL_X0Y13 / GTHE3_COMMON_X0Y3
...
# PCIe Interface
set_property -dict {LOC P2  } [get_ports {pcie_rx_p[0]}] ;# MGTHTXP3_225 GTHE3_CHANNEL_X0Y7 / GTHE3_COMMON_X0Y1
...
set_property -dict {LOC T2  } [get_ports {pcie_rx_p[1]}] ;# MGTHTXP2_225 GTHE3_CHANNEL_X0Y6 / GTHE3_COMMON_X0Y1
...
set_property -dict {LOC V2  } [get_ports {pcie_rx_p[2]}] ;# MGTHTXP1_225 GTHE3_CHANNEL_X0Y5 / GTHE3_COMMON_X0Y1
...
set_property -dict {LOC Y2  } [get_ports {pcie_rx_p[3]}] ;# MGTHTXP0_225 GTHE3_CHANNEL_X0Y4 / GTHE3_COMMON_X0Y1
...
set_property -dict {LOC AB2 } [get_ports {pcie_rx_p[4]}] ;# MGTHTXP3_224 GTHE3_CHANNEL_X0Y3 / GTHE3_COMMON_X0Y0
...
set_property -dict {LOC AD2 } [get_ports {pcie_rx_p[5]}] ;# MGTHTXP2_224 GTHE3_CHANNEL_X0Y2 / GTHE3_COMMON_X0Y0
...
set_property -dict {LOC AE4 } [get_ports {pcie_rx_p[6]}] ;# MGTHTXP1_224 GTHE3_CHANNEL_X0Y1 / GTHE3_COMMON_X0Y0
...
set_property -dict {LOC AF2 } [get_ports {pcie_rx_p[7]}] ;# MGTHTXP0_224 GTHE3_CHANNEL_X0Y0 / GTHE3_COMMON_X0Y0
